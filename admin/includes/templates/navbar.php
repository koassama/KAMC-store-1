...
<div class="sidebar">
  <ul class="nav flex-column">
    ...
    <li class="nav-item"><a class="nav-link" href="users.php?page=manage"><i class="fas fa-users"></i> الموظفين</a></li>
    <li class="nav-item"><a class="nav-link" href="comming.php?page=manage"><i class="fas fa-upload"></i> الأجهزة الصادرة</a></li>
    <li class="nav-item"><a class="nav-link" href="consumers.php?page=manage"><i class="fas fa-sync-alt"></i> المستهلكات</a></li>
    <li class="nav-item"><a class="nav-link" href="products.php?page=manage"><i class="fas fa-warehouse"></i> المخزون</a></li>
