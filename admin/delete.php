...
<body>
    <div class="success-container">
        <div class="success-card">
            ...
            <h2 class="success-title">تم الحذف بنجاح!</h2>
            <p class="success-message">تم حذف السجل من قاعدة البيانات بنجاح.</p>
            <a href="consumers.php" class="btn btn-primary">
...
<body>
    <div class="error-container">
        <div class="error-card">
            ...
            <h2 class="error-title">خطأ في الحذف</h2>
            <p class="error-message">لم يتم العثور على السجل المطلوب حذفه.</p>
            <a href="consumers.php" class="btn btn-primary">
                <i class="fas fa-arrow-right"></i> العودة للقائمة
            </a>
        </div>
...
<body>
    <div class="access-denied-container">
        <div class="access-denied-card">
            ...
            <p class="access-denied-message">ليس لديك صلاحية لحذف هذا السجل.</p>
            <a href="consumers.php" class="btn btn-primary">
                <i class="fas fa-arrow-right"></i> العودة للقائمة
            </a>
        </div>
