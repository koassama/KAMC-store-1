  ...
  if (isset($_SESSION['admin']))
  {
                      ...
                      foreach($users as $user)
                      {
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            {
                              ?>
                              <span class="type e-ty" style="background:grey">موظف</span>
                              <?php
                            }
                              if ($user['type'] == 1)
                              {
                          ...
                          <td>
                            <?php
                              ...
                              {
                                echo 'ليس لديك صلاحية الوصول الى هذا المحتوى';
                              }
                             ?>
              ...
              <div class="row justify-content-end">
                <div class="col-md-8">
                  <form class="add-fomr" method="POST" action="users.php?page=insert" id="form-info"  >
                    <h3>قم بلمئ المعلومات لاضافة موظف جديد<a style="margin-left:5px;font-size:15px;border-radius: 10px;background:var(--mainColor);color:white;padding:8px" href="users.php?page=manage" class="fas fa-long-arrow-alt-right"></a>  </h3>
                      ...
                      <div class="row">
                        ...
                        <div class="col-6">
                          ...
                          <input type="text" name="email" required id="email" placeholder="" class="form-control">
                        </div>
                        <div class="col-6">
                          <label for="username">اسم الموظف</label>
                          <input type="text" name="username"  required id="username" placeholder="" class="form-control">
                        </div>


                        <div class="col-6">
                          <label for="fname">الجوال</label>
                          <input type="text" name="phone"  required id="fname" placeholder="" class="form-control">
                        </div>



                        <div class="col-6">
                          <label for="fname">الوظيفة</label>
                          <input type="text" name="wadifa" required  id="fname" placeholder="" class="form-control">
                        </div>

                             <div class="col-12">
                                <label for="fname">الراتب الاساسي</label>
                                <input type="text" name="ratib"  required id="fname" placeholder="" class="form-control">
                              </div>
                        ...
                        <div class="col-6">
                          ...
                          <input type="password" name="npassword"  required placeholder="" class="form-control">
                        </div>
                        <div class="col-6">
                          <label for="cpassword">تاكيد كلمة المرور</label>
                          <input type="password" name="cpassword" required  placeholder="" class="form-control">
                        </div>

                        <div class="col-12">
                          <label for="type">نوع الموظف </label>
                          <select class="form-control" name="type" required>
                            <option value="default" selected>اختر نوع الموظف</option>
                    ...
                    <input type="button" class="btn btn-primary" id="a-btn-option"  value="اضافة هذا الموظف">
    ...
    elseif ($page == 'insert') {
        ...
        if (empty($email))
      {
        ...
        if (empty($formErrors))
        {
          $stmt = $conn->prepare("INSERT INTO users(username, password,email,type, created,jiha,jinsiya,wadifa,tarikh,ratib,nakl,ramadan,sakan,badalat,idn )
           VALUES(:zusername, :zpass, :zemail, :ztype, now(),:z1,:z2,:z3,:z4,:z4,:z5,:z6,:z7,:z8,:z9,:z10)");
          $stmt->execute(array(
            'zusername' => $username,
            'zpass' => $password,
            'zemail' => $email,
          ...
          <div class="alert alert-success" style="margin-top: 15px">
            <p style="text-align:center">  تم اضافة الموظف بنجاح يرجى اعادة تحميل الصفحة</p>
          </div>
          <?php
          ...
          <div class="edit-page user-edit-pages deep-page">
            <div class="container cnt-spc">
              <div class="row">
                <div class="col-md-12">
                  <div class="pg-tt">
                    <h1 dir="rtl" style="display:block;text-align:right">تعديل الموظف <?php echo $userInfo['fname'] ?></h1>
                  </div>
                </div>
                  ...
                  <div class="use-fl-info">
                    <form method="post" action="users.php?page=update" enctype="multipart/form-data">
                      ...
                      <div class="row">
                        ...
                        <div class="col-6">
                          <label for="email">بريد الالكتروني </label>
                          <input type="text" name="email" id="email" placeholder="" value="<?php echo $userInfo['email'] ?>" class="form-control">
                        </div>
                        <div class="col-6">
                          <label for="email"> اسم المستخدم </label>
                          <input type="text" name="username" id="username" placeholder="" value="<?php echo $userInfo['username'] ?>" class="form-control">
                        </div>
                        <div class="col-6">
                          <label for="fname">الجوال</label>
                          <input type="text" name="phone" id="fname"  value="<?php echo $userInfo['phone'] ?>" placeholder="" class="form-control">
                        </div>

                        <div class="col-6">
                          <label for="fname">الوظيفة</label>
                          <input type="text" name="wadifa" id="fname" value="<?php echo $userInfo['wadifa'] ?>"  placeholder="" class="form-control">
                        </div>


                             <div class="col-12">
                                <label for="fname">الراتب الاساسي</label>
                                <input type="text" name="ratib" id="fname"  value="<?php echo $userInfo['ratib'] ?>" placeholder="" class="form-control">
                              </div>
